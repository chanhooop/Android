...
public class Admin_PastAdapter extends BaseAdapter {
    ...
    public Admin_PastAdapter(Context mContext, int layout, ArrayList<Ad_requestBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView item_title = convertView.findViewById(R.id.pastcard_title);
        ImageView item_image = convertView.findViewById(R.id.pastcard_image);
